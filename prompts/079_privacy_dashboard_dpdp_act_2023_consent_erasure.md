# 079 - Privacy Dashboard, DPDP Act 2023 Consent Logs & Data Erasure

## Purpose
Guarantee statutory user privacy rights and digital sovereignty by implementing a comprehensive privacy dashboard adhering strictly to India's Digital Personal Data Protection Act 2023 (DPDP Act).

This document establishes the authoritative technical blueprint, mathematical models, state machines, API interfaces, failure recovery mechanisms, and regulatory compliance mapping for Privacy Dashboard, DPDP Act 2023 Consent Logs & Data Erasure across the Growww / NBSE platform.

## What You Are Building
A privacy governance engine providing users with granular consent management, personal data download portals (machine-readable JSON), data rectification workflows, and 'Right to Erasure' (Crypto Shredding) pipelines.
...
## Scope Boundaries
- **In Scope:**
- Granular consent management: separate opt-in checkboxes for marketing analytics, promotional SMS, and third-party offers.
- Data portability: one-click export generating an encrypted ZIP containing all personal profile, KYC, and trade records.
- Right to Erasure pipeline: implements 'Crypto Shredding' (destroying user encryption keys) while maintaining 7-year statutory financial audit logs.
- Immutable consent log maintaining cryptographic timestamps of all consent grants and revocations.
- **Out of Scope / Handled Elsewhere:**
- Matching engine microsecond matching.
- WebSocket tick streaming.

## Technology to Use
- Core Technologies: Go privacy service, PostgreSQL encrypted fields (pgcrypto), AWS KMS master key per user, Privacy Dashboard UI.
...
- Privacy Service, User Service, Legal Compliance Portal, Audit Logger, Mobile & Web Settings.

## Blockchain Interaction
Ensures no PII exists on Hyperledger Besu; user wallet addresses remain pseudonymous cryptographic hashes.
...
1. Review system architectural boundaries and regulatory invariants for Privacy Dashboard, DPDP Act 2023 Consent Logs & Data Erasure.
2. Define the core domain entities, data models, and state lifecycle transitions for Privacy Dashboard, DPDP Act 2023 Consent Logs & Data Erasure.
...
package growww.privacy.v1;

option go_package = "growww/packages/proto/growww/privacy/v1;privacyv1";
...
## Acceptance Criteria
- [ ] Core specification and domain data models for Privacy Dashboard, DPDP Act 2023 Consent Logs & Data Erasure fully documented.
...
- **Regulatory Framework:** Digital Personal Data Protection Act 2023 (DPDP Act) Sections 6, 11, 12, and 13 (Rights of Data Principal).
