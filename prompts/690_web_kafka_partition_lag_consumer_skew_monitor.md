# 690 - Web Kafka Partition Lag & Consumer Skew Monitor

## Purpose
Deliver an institutional-grade, highly performant web interface specification for Web Kafka Partition Lag & Consumer Skew Monitor on Next.js 14, providing ultra-low latency, fluid keyboard interactions, and responsive multi-monitor trading layouts.

This document establishes the authoritative technical blueprint, visual UI layout, interactive gestures, state management architecture, failure modes, and acceptance criteria for Web Kafka Partition Lag & Consumer Skew Monitor across the Growww / NBSE trading platform.

## What You Are Building
Streaming telemetry console tracking Kafka topic partitions, consumer group lag, and message serialization rates.
...
1. Review UX design mockups and web interaction requirements for Web Kafka Partition Lag & Consumer Skew Monitor.
...
message WebkafkapartitionlagconsumerskewmonitorState {
  string user_id = 1;
...
service WebkafkapartitionlagconsumerskewmonitorService {
  rpc UpdateViewState(WebkafkapartitionlagconsumerskewmonitorState) returns (WebkafkapartitionlagconsumerskewmonitorState);
}
```
...
## Acceptance Criteria
- [ ] Complete Next.js 14 UI layout, wireframe, and component architecture for Web Kafka Partition Lag & Consumer Skew Monitor fully specified.
