# 638 - Web Demo Trading Analytics: Equity Curve & Sharpe Ratio

## Purpose
Deliver an institutional-grade, highly performant web interface specification for Web Demo Trading Analytics: Equity Curve & Sharpe Ratio on Next.js 14, providing ultra-low latency, fluid keyboard interactions, and responsive multi-monitor trading layouts.

This document establishes the authoritative technical blueprint, visual UI layout, interactive gestures, state management architecture, failure modes, and acceptance criteria for Web Demo Trading Analytics: Equity Curve & Sharpe Ratio across the Growww / NBSE trading platform.

## What You Are Building
Performance analytics dashboard plotting paper trading cumulative PnL, win-rate metrics, and risk-adjusted returns.
...
1. Review UX design mockups and web interaction requirements for Web Demo Trading Analytics: Equity Curve & Sharpe Ratio.
...
message WebdemoanalyticsequitycurvesharperatioState {
  string user_id = 1;
...
service WebdemoanalyticsequitycurvesharperatioService {
  rpc UpdateViewState(WebdemoanalyticsequitycurvesharperatioState) returns (WebdemoanalyticsequitycurvesharperatioState);
}
```
...
## Acceptance Criteria
- [ ] Complete Next.js 14 UI layout, wireframe, and component architecture for Web Demo Trading Analytics: Equity Curve & Sharpe Ratio fully specified.
