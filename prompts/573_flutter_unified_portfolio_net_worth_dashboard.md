# 573 - Flutter Unified Portfolio Net Worth Dashboard: Equities & Crypto

## Purpose
Deliver a production-ready, highly polished Flutter UI and interaction specification for Flutter Unified Portfolio Net Worth Dashboard: Equities & Crypto, providing smooth 60/120 FPS performance and intuitive user ergonomics.

This document establishes the authoritative technical blueprint, visual UI layout, interactive gestures, state management architecture, failure modes, and acceptance criteria for Flutter Unified Portfolio Net Worth Dashboard: Equities & Crypto across the Growww / NBSE trading platform.

## What You Are Building
Consolidated net worth screen in INR combining traditional NSDL/CDSL Demat holdings with live crypto spot assets.

### Visual UI Wireframe & Layout Architecture
```
+-------------------------------------------------------+
| [<-] FLUTTER UNIFIED PORTFOLIO NET WORTH DASHBOARD |
+-------------------------------------------------------+
| [ Dynamic Interactive Control Area                  ] |
|                                                       |
|   Visual Element: Consolidated net worth screen in INR com    |
...
1. Review UX design mockups and interaction requirements for Flutter Unified Portfolio Net Worth Dashboard: Equities & Crypto.
...
service FlutterunifiedportfolionetworthdashboardService {
...
## Acceptance Criteria
- [ ] Complete UI layout, ASCII wireframe, and interaction flows for Flutter Unified Portfolio Net Worth Dashboard: Equities & Crypto fully specified.
