# 697 - Web Institutional Sub-Account Asset Allocation Manager

## Purpose
Deliver an institutional-grade, highly performant web interface specification for Web Institutional Sub-Account Asset Allocation Manager on Next.js 14, providing ultra-low latency, fluid keyboard interactions, and responsive multi-monitor trading layouts.

This document establishes the authoritative technical blueprint, visual UI layout, interactive gestures, state management architecture, failure modes, and acceptance criteria for Web Institutional Sub-Account Asset Allocation Manager across the Growww / NBSE trading platform.

## What You Are Building
Corporate account portal allowing parent organizations to allocate trading limits and view consolidated PnL across desks.
...
1. Review UX design mockups and web interaction requirements for Web Institutional Sub-Account Asset Allocation Manager.
...
message WebinstitutionalsubaccountallocationmanagerState {
  string user_id = 1;
...
service WebinstitutionalsubaccountallocationmanagerService {
  rpc UpdateViewState(WebinstitutionalsubaccountallocationmanagerState) returns (WebinstitutionalsubaccountallocationmanagerState);
}
```
...
## Acceptance Criteria
- [ ] Complete Next.js 14 UI layout, wireframe, and component architecture for Web Institutional Sub-Account Asset Allocation Manager fully specified.
