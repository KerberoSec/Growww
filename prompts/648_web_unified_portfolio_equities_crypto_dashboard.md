# 648 - Web Unified Portfolio Dashboard: NSE/BSE Equities & Crypto

## Purpose
Deliver an institutional-grade, highly performant web interface specification for Web Unified Portfolio Dashboard: NSE/BSE Equities & Crypto on Next.js 14, providing ultra-low latency, fluid keyboard interactions, and responsive multi-monitor trading layouts.

This document establishes the authoritative technical blueprint, visual UI layout, interactive gestures, state management architecture, failure modes, and acceptance criteria for Web Unified Portfolio Dashboard: NSE/BSE Equities & Crypto across the Growww / NBSE trading platform.

## What You Are Building
Consolidated net worth overview in INR combining traditional Demat equity holdings with live crypto spot assets.
...
1. Review UX design mockups and web interaction requirements for Web Unified Portfolio Dashboard: NSE/BSE Equities & Crypto.
...
message WebunifiedportfolioequitiescryptodashboardState {
  string user_id = 1;
...
service WebunifiedportfolioequitiescryptodashboardService {
  rpc UpdateViewState(WebunifiedportfolioequitiescryptodashboardState) returns (WebunifiedportfolioequitiescryptodashboardState);
}
```
...
## Acceptance Criteria
- [ ] Complete Next.js 14 UI layout, wireframe, and component architecture for Web Unified Portfolio Dashboard: NSE/BSE Equities & Crypto fully specified.
