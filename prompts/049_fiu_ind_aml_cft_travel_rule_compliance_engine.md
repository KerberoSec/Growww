# 049 - FIU-IND Suspicious Activity Monitoring & Travel Rule Compliance

## Purpose
Maintain full compliance with the Financial Intelligence Unit - India (FIU-IND) and Prevention of Money Laundering Act (PMLA) by implementing real-time anti-money laundering monitoring and Travel Rule data exchange.

This document establishes the authoritative technical blueprint, mathematical models, state machines, API interfaces, failure recovery mechanisms, and regulatory compliance mapping for FIU-IND Suspicious Activity Monitoring & Travel Rule Compliance across the Growww / NBSE platform.

## What You Are Building
An automated compliance surveillance engine that detects structuring, rapid layering, and high-risk wallet transfers, generating Suspicious Transaction Reports (STRs) and enforcing the IVMS-101 Travel Rule standard.
...
## Scope Boundaries
- **In Scope:**
- Real-time transaction monitoring for cash structuring (deposits just below reporting thresholds) and rapid account churn.
- Automated Suspicious Transaction Report (STR) and Cash Transaction Report (CTR) generation for FIU-IND portal.
- Enforcement of FATF Travel Rule for all crypto withdrawals exceeding 50,000 INR equivalent using IVMS-101 schema.
- Automated blacklisting and freezing of accounts flagged by CERT-In or Indian law enforcement agencies.
- **Out of Scope / Handled Elsewhere:**
- Front-end dark theme styling.
- Demo paper trading balance calculations.

## Technology to Use
- Core Technologies: Go compliance engine, Neo4j graph database for transaction link analysis, TRISA Travel Rule protocol, Kafka event consumer.
...
- AML Surveillance Service, Travel Rule Gateway, User Service, Legal Escalation Portal, Audit Logger.

## Blockchain Interaction
Monitors on-chain addresses interacting with Hyperledger Besu and public blockchains against OFAC/UN sanctions lists.
...
1. Review system architectural boundaries and regulatory invariants for FIU-IND Suspicious Activity Monitoring & Travel Rule Compliance.
2. Define the core domain entities, data models, and state lifecycle transitions for FIU-IND Suspicious Activity Monitoring & Travel Rule Compliance.
...
package growww.compliance.fiu.v1;

option go_package = "growww/packages/proto/growww/compliance/fiu/v1;fiuv1";
...
message ScreenTransactionAMLEvent {
  string event_id = 1;
...
## Acceptance Criteria
- [ ] Core specification and domain data models for FIU-IND Suspicious Activity Monitoring & Travel Rule Compliance fully documented.
...
- **Regulatory Framework:** FIU-IND Reporting Format Guidelines for Virtual Digital Asset Service Providers (VDASPs), PMLA 2002.
