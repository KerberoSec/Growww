# 646 - Web P2P Order Chat & Payment Verification Drawer

## Purpose
Deliver an institutional-grade, highly performant web interface specification for Web P2P Order Chat & Payment Verification Drawer on Next.js 14, providing ultra-low latency, fluid keyboard interactions, and responsive multi-monitor trading layouts.

This document establishes the authoritative technical blueprint, visual UI layout, interactive gestures, state management architecture, failure modes, and acceptance criteria for Web P2P Order Chat & Payment Verification Drawer across the Growww / NBSE trading platform.

## What You Are Building
Real-time encrypted buyer-seller chat drawer for exchanging bank payment UTR reference numbers and payment slips.
...
1. Review UX design mockups and web interaction requirements for Web P2P Order Chat & Payment Verification Drawer.
...
message Webp2porderchatpaymentverificationdrawerState {
  string user_id = 1;
...
service Webp2porderchatpaymentverificationdrawerService {
  rpc UpdateViewState(Webp2porderchatpaymentverificationdrawerState) returns (Webp2porderchatpaymentverificationdrawerState);
}
```
...
## Acceptance Criteria
- [ ] Complete Next.js 14 UI layout, wireframe, and component architecture for Web P2P Order Chat & Payment Verification Drawer fully specified.
