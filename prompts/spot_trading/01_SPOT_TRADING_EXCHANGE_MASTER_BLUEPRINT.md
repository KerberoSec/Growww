...
|  |  Universal 0.00% Zero-Fee at launch (0 bps deducted from transaction proceeds):                      |  |
...
- Fee Rate: 0.00% (Zero Fee) of gross notional trade value (0 bps at launch; FeeController governed).
...
- Calculation Formula:
  `PlatformFee = TradePrice * TradeQuantity * 0.0000` (0 at launch)
