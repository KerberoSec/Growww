# 549 - Flutter Stop-Limit & Stop-Market Conditional Trigger Screen

## Purpose
Deliver a production-ready, highly polished Flutter UI and interaction specification for Flutter Stop-Limit & Stop-Market Conditional Trigger Screen, providing smooth 60/120 FPS performance and intuitive user ergonomics.

This document establishes the authoritative technical blueprint, visual UI layout, interactive gestures, state management architecture, failure modes, and acceptance criteria for Flutter Stop-Limit & Stop-Market Conditional Trigger Screen across the Growww / NBSE trading platform.

## What You Are Building
Conditional order setup sheet with trigger price picker, mark vs last price radio, and stop condition logic.
...
|                                                       |
|   Visual Element: Conditional order setup sheet with trigg    |
...
1. Review UX design mockups and interaction requirements for Flutter Stop-Limit & Stop-Market Conditional Trigger Screen.
...
service FlutterstoplimittriggerconfigurationscreenService {
...
## Acceptance Criteria
- [ ] Complete UI layout, ASCII wireframe, and interaction flows for Flutter Stop-Limit & Stop-Market Conditional Trigger Screen fully specified.
