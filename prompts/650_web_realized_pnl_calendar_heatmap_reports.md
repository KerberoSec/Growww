# 650 - Web Realized PnL Calendar Heatmap & Tax Reports

## Purpose
Deliver an institutional-grade, highly performant web interface specification for Web Realized PnL Calendar Heatmap & Tax Reports on Next.js 14, providing ultra-low latency, fluid keyboard interactions, and responsive multi-monitor trading layouts.

This document establishes the authoritative technical blueprint, visual UI layout, interactive gestures, state management architecture, failure modes, and acceptance criteria for Web Realized PnL Calendar Heatmap & Tax Reports across the Growww / NBSE trading platform.

## What You Are Building
Financial calendar heatmap displaying daily trading profits and losses with CSV/Excel export for statutory tax filings.
...
1. Review UX design mockups and web interaction requirements for Web Realized PnL Calendar Heatmap & Tax Reports.
...
message WebrealizedpnlcalendarheatmapreportsState {
  string user_id = 1;
...
service WebrealizedpnlcalendarheatmapreportsService {
  rpc UpdateViewState(WebrealizedpnlcalendarheatmapreportsState) returns (WebrealizedpnlcalendarheatmapreportsState);
}
```
...
## Acceptance Criteria
- [ ] Complete Next.js 14 UI layout, wireframe, and component architecture for Web Realized PnL Calendar Heatmap & Tax Reports fully specified.
