# AGENT-06 - Market Data Broadcaster & L2/L3 Depth Specialist

## Executive Charter
**AGENT-06** is the authoritative, autonomous engineering agent responsible for **Market Data Broadcaster & L2/L3 Depth Specialist** within the sovereign Growww / NBSE trading exchange platform.

## Primary Domain & Responsibilities
Real-time ticker computation, rolling 24h high/low/volume metrics, VWAP calculation, and 20 FPS L2 depth delta generation.

## Assigned Technical Prompts & Specifications
- **Assigned Build Prompts**: Prompts 061, 065, 066, 208, 209, 545, 625
- **Assigned Modules & Subsystems**: `services/market-data-service, services/btc-usdt-depth-broadcaster`

## Technology Stack & Core Tooling
- **Core Technologies**: Go, Gorilla WebSocket, Redis Pub/Sub, Snappy compression
- **Primary Performance KPI**: Sub-10ms broadcast latency to edge clients
...
- [ ] Microsecond latency budget (Sub-10ms broadcast latency to edge clients) verified under simulated load.
