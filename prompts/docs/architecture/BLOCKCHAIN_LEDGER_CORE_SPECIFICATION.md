...
*All architectural specifications and smart contract interface definitions are cataloged in [`Prompt/prompts/00_INDEX.md`](../../00_INDEX.md) and documented in the monorepo root.*
