# 668 - Web RWA Primary Issuance & Dutch Auction Investor Portal

## Purpose
Deliver an institutional-grade, highly performant web interface specification for Web RWA Primary Issuance & Dutch Auction Investor Portal on Next.js 14, providing ultra-low latency, fluid keyboard interactions, and responsive multi-monitor trading layouts.

This document establishes the authoritative technical blueprint, visual UI layout, interactive gestures, state management architecture, failure modes, and acceptance criteria for Web RWA Primary Issuance & Dutch Auction Investor Portal across the Growww / NBSE trading platform.

## What You Are Building
Primary market subscription portal for tokenized government treasury bills, corporate bonds, and infrastructure debt.
...
1. Review UX design mockups and web interaction requirements for Web RWA Primary Issuance & Dutch Auction Investor Portal.
...
message WebrwaprimaryissuancedutchauctionportalState {
  string user_id = 1;
...
service WebrwaprimaryissuancedutchauctionportalService {
  rpc UpdateViewState(WebrwaprimaryissuancedutchauctionportalState) returns (WebrwaprimaryissuancedutchauctionportalState);
}
```
...
## Acceptance Criteria
- [ ] Complete Next.js 14 UI layout, wireframe, and component architecture for Web RWA Primary Issuance & Dutch Auction Investor Portal fully specified.
