# 636 - Web Demo Paper Trading Cockpit & Live Market Mirror

## Purpose
Deliver an institutional-grade, highly performant web interface specification for Web Demo Paper Trading Cockpit & Live Market Mirror on Next.js 14, providing ultra-low latency, fluid keyboard interactions, and responsive multi-monitor trading layouts.

This document establishes the authoritative technical blueprint, visual UI layout, interactive gestures, state management architecture, failure modes, and acceptance criteria for Web Demo Paper Trading Cockpit & Live Market Mirror across the Growww / NBSE trading platform.

## What You Are Building
Full-featured paper trading simulation cockpit mirroring live Binance/Coinbase BTC/USDT prices with zero capital risk.
...
1. Review UX design mockups and web interaction requirements for Web Demo Paper Trading Cockpit & Live Market Mirror.
...
message WebdemopapertradingsimulatorcockpitState {
  string user_id = 1;
...
service WebdemopapertradingsimulatorcockpitService {
  rpc UpdateViewState(WebdemopapertradingsimulatorcockpitState) returns (WebdemopapertradingsimulatorcockpitState);
}
```
...
## Acceptance Criteria
- [ ] Complete Next.js 14 UI layout, wireframe, and component architecture for Web Demo Paper Trading Cockpit & Live Market Mirror fully specified.
