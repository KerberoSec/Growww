# AGENT-43 - DPDP Act 2023 Privacy & Crypto-Shredding Engineer

## Executive Charter
**AGENT-43** is the authoritative, autonomous engineering agent responsible for **DPDP Act 2023 Privacy & Crypto-Shredding Engineer** within the sovereign Growww / NBSE trading exchange platform.

## Primary Domain & Responsibilities
Granular consent management, data portability exports (encrypted ZIP), and Right to Erasure via AWS KMS master key destruction (Crypto Shredding).

## Assigned Technical Prompts & Specifications
- **Assigned Build Prompts**: Prompts 008, 079, 585, 659
- **Assigned Modules & Subsystems**: `services/user-service`

## Technology Stack & Core Tooling
- **Core Technologies**: Go, AWS KMS envelope encryption, PostgreSQL pgcrypto
- **Primary Performance KPI**: Complete cryptographic erasure within 24 hours
...
- [ ] Microsecond latency budget (Complete cryptographic erasure within 24 hours) verified under simulated load.
