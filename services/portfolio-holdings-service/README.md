...
## Executive Overview
`portfolio-holdings-service` is an institutional-grade microservice written in **Go** within the Growww / NBSE trading platform architecture.

## Primary Responsibility
Real-time consolidated portfolio valuation engine combining traditional equities and crypto assets.

## Interface & Communication Boundaries
- **Primary gRPC Service**: `PortfolioHoldingsService` (defined in `packages/proto/`)
- **Inbound Event Stream**: `trade.executions.v1`
- **Outbound Event Stream**: `portfolio.snapshots.v1`
