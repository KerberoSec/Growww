# continuous-regulatory-dispatcher

## Executive Overview
`continuous-regulatory-dispatcher` is an institutional-grade microservice written in **Go** within the Growww / NBSE trading platform architecture.

## Primary Responsibility
Real-time audit log dispatcher streaming cryptographic compliance proofs to regulatory supervisory nodes.

## Interface & Communication Boundaries
- **Primary gRPC Service**: `RegulatoryDispatcherService` (defined in `packages/proto/`)
- **Inbound Event Stream**: `audit.receipts.v1`
- **Outbound Event Stream**: `regulatory.stream.v1`
