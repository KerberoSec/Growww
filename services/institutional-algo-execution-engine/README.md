# institutional-algo-execution-engine

## Executive Overview
`institutional-algo-execution-engine` is an institutional-grade microservice written in **Go** within the Growww / NBSE trading platform architecture.

## Primary Responsibility
Institutional execution engine executing TWAP, VWAP, and volume-participation algorithms.

## Interface & Communication Boundaries
- **Primary gRPC Service**: `InstitutionalAlgoService` (defined in `packages/proto/`)
- **Inbound Event Stream**: `inst.orders.v1`
