# auction-delivery-failure-resolver

## Executive Overview
`auction-delivery-failure-resolver` is an institutional-grade microservice written in **Go** within the Growww / NBSE trading platform architecture.

## Primary Responsibility
Automated auctioneer and penalty calculator resolving failed security deliveries.

## Interface & Communication Boundaries
- **Primary gRPC Service**: `AuctionResolverService` (defined in `packages/proto/`)
- **Inbound Event Stream**: `delivery.failures.v1`
- **Outbound Event Stream**: `auction.settlements.v1`
