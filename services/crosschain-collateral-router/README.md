# crosschain-collateral-router

## Executive Overview
`crosschain-collateral-router` is an institutional-grade microservice written in **Go** within the Growww / NBSE trading platform architecture.

## Primary Responsibility
Multi-chain liquidity router locking and verifying collateral across foreign smart contracts.

## Interface & Communication Boundaries
- **Primary gRPC Service**: `CrosschainCollateralRouterService` (defined in `packages/proto/`)
- **Inbound Event Stream**: `collateral.locks.v1`
- **Outbound Event Stream**: `collateral.verified.v1`
