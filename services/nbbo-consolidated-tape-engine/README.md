# nbbo-consolidated-tape-engine

## Executive Overview
`nbbo-consolidated-tape-engine` is an institutional-grade microservice written in **Go** within the Growww / NBSE trading platform architecture.

## Primary Responsibility
Consolidated market tape calculating National Best Bid and Offer (NBBO) across liquidity pools.

## Interface & Communication Boundaries
- **Primary gRPC Service**: `NBBOConsolidatedTapeService` (defined in `packages/proto/`)
- **Inbound Event Stream**: `external.quotes.v1`
- **Outbound Event Stream**: `consolidated.nbbo.v1`
