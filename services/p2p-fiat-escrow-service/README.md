# p2p-fiat-escrow-service

## Executive Overview
`p2p-fiat-escrow-service` is an institutional-grade microservice written in **Go** within the Growww / NBSE trading platform architecture.

## Primary Responsibility
Peer-to-peer INR-to-USDT smart contract escrow coordinator and banking reference verifier.

## Interface & Communication Boundaries
- **Primary gRPC Service**: `P2PEscrowService` (defined in `packages/proto/`)
- **Inbound Event Stream**: `p2p.trades.v1`
- **Outbound Event Stream**: `p2p.escrow.v1`
