# clearing-corp-interop-gateway

## Executive Overview
`clearing-corp-interop-gateway` is an institutional-grade microservice written in **Go** within the Growww / NBSE trading platform architecture.

## Primary Responsibility
Interoperability gateway connecting with clearing corporations (NSCCL, ICCL) for multi-asset clearing.

## Interface & Communication Boundaries
- **Primary gRPC Service**: `ClearingInteropService` (defined in `packages/proto/`)
- **Inbound Event Stream**: `clearing.trades.v1`
- **Outbound Event Stream**: `clearing.reports.v1`
