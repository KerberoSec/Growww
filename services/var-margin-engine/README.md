...
## Executive Overview
`var-margin-engine` is an institutional-grade microservice written in **Rust** within the Growww / NBSE trading platform architecture.

## Primary Responsibility
Value-at-Risk (VaR) mathematical engine calculating portfolio margin requirements across cross-asset portfolios.

## Interface & Communication Boundaries
- **Primary gRPC Service**: `VaRMarginEngineService` (defined in `packages/proto/`)
- **Inbound Event Stream**: `portfolio.states.v1`
- **Outbound Event Stream**: `margin.requirements.v1`
