...
## Executive Overview
`payment-gateway-service` is an institutional-grade microservice written in **Go** within the Growww / NBSE trading platform architecture.

## Primary Responsibility
Specialized microservice supporting the payment gateway service functionality of the trading exchange.

## Interface & Communication Boundaries
- **Primary gRPC Service**: `PaymentgatewayserviceService` (defined in `packages/proto/`)
- **Inbound Event Stream**: `payment-gateway-service.in.v1`
- **Outbound Event Stream**: `payment-gateway-service.out.v1`
