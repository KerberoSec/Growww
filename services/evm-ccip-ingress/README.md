...
## Executive Overview
`evm-ccip-ingress` is an institutional-grade microservice written in **Go** within the Growww / NBSE trading platform architecture.

## Primary Responsibility
Chainlink CCIP cross-chain interoperability protocol listener for cross-chain token transfers.

## Interface & Communication Boundaries
- **Primary gRPC Service**: `EVMCCIPIngressService` (defined in `packages/proto/`)
- **Inbound Event Stream**: `ccip.messages.v1`
- **Outbound Event Stream**: `ccip.transfers.v1`
