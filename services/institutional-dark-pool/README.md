...
## Executive Overview
`institutional-dark-pool` is an institutional-grade microservice written in **Go** within the Growww / NBSE trading platform architecture.

## Primary Responsibility
Specialized microservice supporting the institutional dark pool functionality of the trading exchange.

## Interface & Communication Boundaries
- **Primary gRPC Service**: `InstitutionaldarkpoolService` (defined in `packages/proto/`)
- **Inbound Event Stream**: `institutional-dark-pool.in.v1`
- **Outbound Event Stream**: `institutional-dark-pool.out.v1`
