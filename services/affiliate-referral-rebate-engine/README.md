# affiliate-referral-rebate-engine

## Executive Overview
`affiliate-referral-rebate-engine` is an institutional-grade microservice written in **Go** within the Growww / NBSE trading platform architecture.

## Primary Responsibility
Calculates multi-tier affiliate commissions, fee shares, and instant rebate distributions.

## Interface & Communication Boundaries
- **Primary gRPC Service**: `AffiliateRebateEngineService` (defined in `packages/proto/`)
- **Inbound Event Stream**: `trade.fees.v1`
- **Outbound Event Stream**: `rebate.distributions.v1`
