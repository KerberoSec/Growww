...
## Executive Overview
`audit-log-service` is an institutional-grade microservice written in **Go** within the Growww / NBSE trading platform architecture.

## Primary Responsibility
Immutable Write-Once-Read-Many (WORM) audit logging service preserving 7-year regulatory compliance records.

## Interface & Communication Boundaries
- **Primary gRPC Service**: `AuditLogService` (defined in `packages/proto/`)
- **Inbound Event Stream**: `platform.events.v1`
- **Outbound Event Stream**: `audit.records.v1`
