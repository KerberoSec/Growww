...
## Executive Overview
`bond-yield-calculator` is an institutional-grade microservice written in **Go** within the Growww / NBSE trading platform architecture.

## Primary Responsibility
Calculates yield-to-maturity (YTM), duration, and accrued interest on tokenized government securities (G-Secs).

## Interface & Communication Boundaries
- **Primary gRPC Service**: `BondYieldCalculatorService` (defined in `packages/proto/`)
- **Inbound Event Stream**: `bond.trades.v1`
- **Outbound Event Stream**: `yield.accruals.v1`
