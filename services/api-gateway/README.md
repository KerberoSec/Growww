...
## Executive Overview
`api-gateway` is an institutional-grade microservice written in **Go / Envoy** within the Growww / NBSE trading platform architecture.

## Primary Responsibility
Edge reverse proxy handling TLS termination, JWT authentication, and request routing.

## Interface & Communication Boundaries
- **Primary gRPC Service**: `APIGatewayService` (defined in `packages/proto/`)
- **Inbound Event Stream**: `gateway.requests.v1`
- **Outbound Event Stream**: `gateway.access.v1`
