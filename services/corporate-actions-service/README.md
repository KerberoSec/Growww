...
## Executive Overview
`corporate-actions-service` is an institutional-grade microservice written in **Go** within the Growww / NBSE trading platform architecture.

## Primary Responsibility
Processes dividends, stock splits, bonus shares, and crypto hard forks across investor portfolios.

## Interface & Communication Boundaries
- **Primary gRPC Service**: `CorporateActionsService` (defined in `packages/proto/`)
- **Inbound Event Stream**: `corporate.events.v1`
- **Outbound Event Stream**: `portfolio.adjustments.v1`
