...
## Executive Overview
`tax-reporting-service` is an institutional-grade microservice written in **Go** within the Growww / NBSE trading platform architecture.

## Primary Responsibility
Automated tax accounting engine deducting zero on-chain TDS (Section 194S) and tracking 30% VDA gains (Section 115BBH).

## Interface & Communication Boundaries
- **Primary gRPC Service**: `TaxReportingService` (defined in `packages/proto/`)
- **Inbound Event Stream**: `trade.settlements.v1`
- **Outbound Event Stream**: `growww.tax.reports.v1`
