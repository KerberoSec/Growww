# copy-trading-replication-service

## Executive Overview
`copy-trading-replication-service` is an institutional-grade microservice written in **Go** within the Growww / NBSE trading platform architecture.

## Primary Responsibility
Sub-50ms copy trading replication engine proportionally copying master trader orders to followers.

## Interface & Communication Boundaries
- **Primary gRPC Service**: `CopyTradingReplicationService` (defined in `packages/proto/`)
- **Inbound Event Stream**: `master.trades.v1`
- **Outbound Event Stream**: `follower.orders.v1`
