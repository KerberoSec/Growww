# settlement-relayer-gas-escalator

## Executive Overview
`settlement-relayer-gas-escalator` is an institutional-grade microservice written in **Go** within the Growww / NBSE trading platform architecture.

## Primary Responsibility
On-chain transaction submission relayer with automated dynamic gas replacement.

## Interface & Communication Boundaries
- **Primary gRPC Service**: `SettlementRelayerService` (defined in `packages/proto/`)
- **Inbound Event Stream**: `settlement.batches.v1`
- **Outbound Event Stream**: `onchain.receipts.v1`
