...
## Executive Overview
`mcx-commodity-adapter` is an institutional-grade microservice written in **Go** within the Growww / NBSE trading platform architecture.

## Primary Responsibility
Multi Commodity Exchange of India (MCX) feed connector for gold, silver, and energy asset pricing.

## Interface & Communication Boundaries
- **Primary gRPC Service**: `MCXCommodityAdapterService` (defined in `packages/proto/`)
- **Inbound Event Stream**: `mcx.raw.feed.v1`
- **Outbound Event Stream**: `market.commodity.v1`
