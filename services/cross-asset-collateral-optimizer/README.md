# cross-asset-collateral-optimizer

## Executive Overview
`cross-asset-collateral-optimizer` is an institutional-grade microservice written in **Rust** within the Growww / NBSE trading platform architecture.

## Primary Responsibility
Linear programming optimizer allocating user capital across equity, crypto, and cash to minimize margin lock.

## Interface & Communication Boundaries
- **Primary gRPC Service**: `CollateralOptimizerService` (defined in `packages/proto/`)
- **Inbound Event Stream**: `portfolio.assets.v1`
- **Outbound Event Stream**: `optimized.allocations.v1`
