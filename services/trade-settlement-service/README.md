...
## Executive Overview
`trade-settlement-service` is an institutional-grade microservice written in **Go** within the Growww / NBSE trading platform architecture.

## Primary Responsibility
Master Delivery-versus-Payment (DvP) trade settlement orchestrator clearing trades on Hyperledger Besu.

## Interface & Communication Boundaries
- **Primary gRPC Service**: `SettlementOrchestratorService` (defined in `packages/proto/`)
- **Inbound Event Stream**: `market.trades.v1`
- **Outbound Event Stream**: `settlement.batches.v1`
