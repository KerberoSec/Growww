# crosschain-reorg-saga-coordinator

## Executive Overview
`crosschain-reorg-saga-coordinator` is an institutional-grade microservice written in **Go** within the Growww / NBSE trading platform architecture.

## Primary Responsibility
Distributed Saga coordinator rolling back unfinalized state upon deep public chain reorganizations.

## Interface & Communication Boundaries
- **Primary gRPC Service**: `ReorgSagaCoordinatorService` (defined in `packages/proto/`)
- **Inbound Event Stream**: `chain.reorg.v1`
- **Outbound Event Stream**: `saga.compensations.v1`
