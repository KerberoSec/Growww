# crypto-withdrawal-clearing-engine

## Executive Overview
`crypto-withdrawal-clearing-engine` is an institutional-grade microservice written in **Go** within the Growww / NBSE trading platform architecture.

## Primary Responsibility
Automated cryptocurrency withdrawal pipeline with AML forensics, time-locks, and batch sweeps.

## Interface & Communication Boundaries
- **Primary gRPC Service**: `CryptoWithdrawalClearingService` (defined in `packages/proto/`)
- **Inbound Event Stream**: `withdrawal.requests.v1`
- **Outbound Event Stream**: `withdrawal.dispatches.v1`
