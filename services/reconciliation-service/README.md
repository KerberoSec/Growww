...
## Executive Overview
`reconciliation-service` is an institutional-grade microservice written in **Go** within the Growww / NBSE trading platform architecture.

## Primary Responsibility
End-of-day multi-way reconciliation engine comparing orderbooks, bank balances, and Besu on-chain state.

## Interface & Communication Boundaries
- **Primary gRPC Service**: `ReconciliationService` (defined in `packages/proto/`)
- **Inbound Event Stream**: `reconciliation.jobs.v1`
- **Outbound Event Stream**: `reconciliation.discrepancies.v1`
