...
## Executive Overview
`order-service` is an institutional-grade microservice written in **Go** within the Growww / NBSE trading platform architecture.

## Primary Responsibility
Order lifecycle management service handling client ingress, validation, and cancel routing.

## Interface & Communication Boundaries
- **Primary gRPC Service**: `OrderGatewayService` (defined in `packages/proto/`)
- **Inbound Event Stream**: `user.orders.v1`
