...
## Executive Overview
`market-surveillance-engine` is an institutional-grade microservice written in **Go** within the Growww / NBSE trading platform architecture.

## Primary Responsibility
Algorithmic market surveillance engine detecting wash trading, spoofing, layering, and pump-and-dump schemes.

## Interface & Communication Boundaries
- **Primary gRPC Service**: `MarketSurveillanceService` (defined in `packages/proto/`)
- **Inbound Event Stream**: `market.tape.v1`
- **Outbound Event Stream**: `surveillance.alerts.v1`
