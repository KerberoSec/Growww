# erc4337-bundler-paymaster-service

## Executive Overview
`erc4337-bundler-paymaster-service` is an institutional-grade microservice written in **Go** within the Growww / NBSE trading platform architecture.

## Primary Responsibility
ERC-4337 Account Abstraction UserOperation bundler and sponsored gas paymaster daemon.

## Interface & Communication Boundaries
- **Primary gRPC Service**: `ERC4337BundlerService` (defined in `packages/proto/`)
- **Inbound Event Stream**: `userops.ingress.v1`
- **Outbound Event Stream**: `userops.bundles.v1`
