...
## Executive Overview
`nse-bse-adapter` is an institutional-grade microservice written in **Go** within the Growww / NBSE trading platform architecture.

## Primary Responsibility
Traditional market data adapter ingesting live feeds from the National Stock Exchange and Bombay Stock Exchange.

## Interface & Communication Boundaries
- **Primary gRPC Service**: `NSEBSEAdapterService` (defined in `packages/proto/`)
- **Inbound Event Stream**: `nse.raw.feed.v1`
- **Outbound Event Stream**: `market.equity.v1`
