...
## Executive Overview
`perpetuals-engine` is an institutional-grade microservice written in **Rust** within the Growww / NBSE trading platform architecture.

## Primary Responsibility
Perpetual futures risk engine calculating 8-hour funding rates, mark prices, and leverage brackets.

## Interface & Communication Boundaries
- **Primary gRPC Service**: `PerpetualsEngineService` (defined in `packages/proto/`)
- **Inbound Event Stream**: `futures.orders.v1`
- **Outbound Event Stream**: `funding.payments.v1`
