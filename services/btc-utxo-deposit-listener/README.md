# btc-utxo-deposit-listener

## Executive Overview
`btc-utxo-deposit-listener` is an institutional-grade microservice written in **Go** within the Growww / NBSE trading platform architecture.

## Primary Responsibility
High-performance Bitcoin node listener monitoring mempools, Taproot scripts, and 6-block finality.

## Interface & Communication Boundaries
- **Primary gRPC Service**: `BTCUTXOListenerService` (defined in `packages/proto/`)
- **Inbound Event Stream**: `btc.raw.tx.v1`
- **Outbound Event Stream**: `btc.confirmed.deposits.v1`
