# gift-city-funding-service

## Executive Overview
`gift-city-funding-service` is an institutional-grade microservice written in **Go** within the Growww / NBSE trading platform architecture.

## Primary Responsibility
International multi-currency banking gateway (USD/EUR/AED) for GIFT City offshore trading accounts.

## Interface & Communication Boundaries
- **Primary gRPC Service**: `GIFTCityFundingService` (defined in `packages/proto/`)
- **Inbound Event Stream**: `giftcity.wires.v1`
- **Outbound Event Stream**: `giftcity.credits.v1`
