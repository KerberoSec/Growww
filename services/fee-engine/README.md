...
## Executive Overview
`fee-engine` is an institutional-grade microservice written in **Go** within the Growww / NBSE trading platform architecture.

## Primary Responsibility
Calculates dynamic maker/taker trading fees based on 30-day volume tiers and platform token staking.

## Interface & Communication Boundaries
- **Primary gRPC Service**: `FeeEngineService` (defined in `packages/proto/`)
- **Inbound Event Stream**: `orders.evaluated.v1`
- **Outbound Event Stream**: `fees.applied.v1`
