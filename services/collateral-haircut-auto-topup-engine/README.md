# collateral-haircut-auto-topup-engine

## Executive Overview
`collateral-haircut-auto-topup-engine` is an institutional-grade microservice written in **Go** within the Growww / NBSE trading platform architecture.

## Primary Responsibility
Monitors pledged collateral values, calculates dynamic haircuts, and triggers automatic margin top-ups.

## Interface & Communication Boundaries
- **Primary gRPC Service**: `CollateralHaircutTopupService` (defined in `packages/proto/`)
- **Inbound Event Stream**: `collateral.valuations.v1`
- **Outbound Event Stream**: `margin.calls.v1`
