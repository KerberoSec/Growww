...
## Executive Overview
`kyc-aml-service` is an institutional-grade microservice written in **Go** within the Growww / NBSE trading platform architecture.

## Primary Responsibility
Tiered KYC identity verification engine integrating Aadhaar OTP, PAN verification, and video liveness.

## Interface & Communication Boundaries
- **Primary gRPC Service**: `KYCAMLService` (defined in `packages/proto/`)
- **Inbound Event Stream**: `kyc.submissions.v1`
- **Outbound Event Stream**: `kyc.verifications.v1`
