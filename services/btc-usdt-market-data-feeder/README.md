# btc-usdt-market-data-feeder

## Executive Overview
`btc-usdt-market-data-feeder` is an institutional-grade microservice written in **Go** within the Growww / NBSE trading platform architecture.

## Primary Responsibility
Dedicated sub-millisecond price quote feeder for the primary BTC/USDT spot trading pair.

## Interface & Communication Boundaries
- **Primary gRPC Service**: `BTCUSDTDataFeederService` (defined in `packages/proto/`)
- **Inbound Event Stream**: `raw.btc.trades.v1`
- **Outbound Event Stream**: `market.btc.feed.v1`
