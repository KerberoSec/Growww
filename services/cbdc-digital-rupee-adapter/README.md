# cbdc-digital-rupee-adapter

## Executive Overview
`cbdc-digital-rupee-adapter` is an institutional-grade microservice written in **Go** within the Growww / NBSE trading platform architecture.

## Primary Responsibility
Reserve Bank of India (RBI) e-Rupee CBDC banking adapter for wholesale and retail settlement.

## Interface & Communication Boundaries
- **Primary gRPC Service**: `CBDCAdapterService` (defined in `packages/proto/`)
- **Inbound Event Stream**: `cbdc.transfers.v1`
- **Outbound Event Stream**: `cbdc.receipts.v1`
