# nbse-fee-distribution-engine

## Executive Overview
`nbse-fee-distribution-engine` is an institutional-grade microservice written in **Go** within the Growww / NBSE trading platform architecture.

## Primary Responsibility
Distributes collected transaction fees between treasury, liquidity rebate pool, and insurance fund.

## Interface & Communication Boundaries
- **Primary gRPC Service**: `NBSEFeeDistributionService` (defined in `packages/proto/`)
- **Inbound Event Stream**: `fees.collected.v1`
- **Outbound Event Stream**: `treasury.splits.v1`
