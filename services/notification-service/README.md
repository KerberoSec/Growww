...
## Executive Overview
`notification-service` is an institutional-grade microservice written in **Go** within the Growww / NBSE trading platform architecture.

## Primary Responsibility
Real-time notification engine dispatching push notifications, SMS alerts, and encrypted emails.

## Interface & Communication Boundaries
- **Primary gRPC Service**: `NotificationService` (defined in `packages/proto/`)
- **Inbound Event Stream**: `notifications.dispatch.v1`
- **Outbound Event Stream**: `notifications.status.v1`
