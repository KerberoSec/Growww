...
## Executive Overview
`regulatory-reporting-service` is an institutional-grade microservice written in **Go** within the Growww / NBSE trading platform architecture.

## Primary Responsibility
Automated compliance export engine producing SEBI, RBI, and IFSCA daily statutory regulatory filings.

## Interface & Communication Boundaries
- **Primary gRPC Service**: `RegulatoryReportingService` (defined in `packages/proto/`)
- **Inbound Event Stream**: `compliance.reports.v1`
- **Outbound Event Stream**: `statutory.filings.v1`
