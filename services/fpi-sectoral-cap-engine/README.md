# fpi-sectoral-cap-engine

## Executive Overview
`fpi-sectoral-cap-engine` is an institutional-grade microservice written in **Go** within the Growww / NBSE trading platform architecture.

## Primary Responsibility
Monitors Foreign Portfolio Investor (FPI) sectoral investment caps under Indian FEMA regulations.

## Interface & Communication Boundaries
- **Primary gRPC Service**: `FPISectoralCapService` (defined in `packages/proto/`)
- **Inbound Event Stream**: `foreign.trades.v1`
- **Outbound Event Stream**: `fpi.limits.v1`
