# sebi-margin-pledge-gateway

## Executive Overview
`sebi-margin-pledge-gateway` is an institutional-grade microservice written in **Go** within the Growww / NBSE trading platform architecture.

## Primary Responsibility
SEBI-compliant margin pledge/re-pledge verification gateway interfacing with NSDL/CDSL depositories.

## Interface & Communication Boundaries
- **Primary gRPC Service**: `SEBIMarginPledgeGatewayService` (defined in `packages/proto/`)
- **Inbound Event Stream**: `margin.pledge.v1`
- **Outbound Event Stream**: `pledge.acknowledgements.v1`
