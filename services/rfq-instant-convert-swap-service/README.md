# rfq-instant-convert-swap-service

## Executive Overview
`rfq-instant-convert-swap-service` is an institutional-grade microservice written in **Go** within the Growww / NBSE trading platform architecture.

## Primary Responsibility
Request-for-Quote (RFQ) OTC conversion engine providing guaranteed zero-slippage spot swaps.

## Interface & Communication Boundaries
- **Primary gRPC Service**: `RFQInstantConvertService` (defined in `packages/proto/`)
- **Inbound Event Stream**: `rfq.requests.v1`
- **Outbound Event Stream**: `rfq.quotes.v1`
