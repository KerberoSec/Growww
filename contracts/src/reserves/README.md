# Proof-of-Reserve & Solvency Registry Contracts

## Purpose & Scope
The `reserves` smart contract module is part of the sovereign Growww / NBSE on-chain clearing infrastructure on Hyperledger Besu.

## Core Architectural Responsibilities
On-chain registry contracts publishing hourly Merkle liability roots and reserve attestations.
...
## Local Testing
```bash
forge test --match-path reserves/** -vvv
```
